...
public class SimpleRedisService implements InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		jedis = JedisUtil.createJedis(jedisConfig.getHost(), Integer.parseInt(jedisConfig.getPort()));
	}
    ...
    public void changeJedis() {
    	System.out.println("start to change jedis hosts to: " + jedisConfig.getHost() + " : " + jedisConfig.getPort());
